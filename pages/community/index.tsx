      ...
      <div className="px-4 space-y-8">
        {[1, 2, 3, 4, 5, 6].map((_, i) => (
          <div key={i} className="flex flex-col items-start">
            ...
            <div className="mt-5 flex items-center justify-between w-full text-gray-500 font-bold text-xs">
              <span>니꼬</span>
              <span>18시간 전</span>
            </div>
        ...
        <button className="fixed bottom-24 right-5 bg-orange-400 rounded-full shadow-xl p-4 text-white hover:bg-orange-500 cursor-pointer transition-colors">
          <svg
            className="w-6 h-6"
            fill="none"
            stroke="currentColor"
