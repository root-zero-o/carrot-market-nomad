    ...
    <div className="py-10 px-4">
      <div className="flex items-center space-x-3">
        ...
        <div className="flex flex-col">
          <span className="font-bold text-gray-900">Steve Jebs</span>
      ...
      <div className="mt-10 flex justify-around">
        <div className="flex flex-col items-center">
          ...
          <span className="text-sm mt-2 font-bold text-gray-700">판매내역</span>
        </div>
        <div className="flex flex-col items-center">
          <div className="w-14 h-14 text-white bg-orange-500 rounded-full flex items-center justify-center">
            <svg
          ...
          <span className="text-sm mt-2 font-bold text-gray-700">구매내역</span>
        </div>
        <div className="flex flex-col items-center">
          <div className="w-14 h-14 text-white bg-orange-500 rounded-full flex items-center justify-center">
            <svg
          ...
          <span className="text-sm mt-2 font-bold text-gray-700">관심목록</span>
        </div>
      </div>
      <div className="mt-12">
