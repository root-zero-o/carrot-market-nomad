        ...
        <div className="mb-8">
          ...
          <div className="flex cursor-pointer py-3 border-t border-b items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs font-bold text-gray text-gray-500">
                View profile &rarr;
              </p>
            </div>
          </div>
          <div className="mt-5 ">
            ...
            <div className="flex items-center justify-between space-x-2">
              <button className="flex-1 bg-orange-500 text-white py-3 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 font-bold hover:bg-orange-600">
                Talk to seller
              </button>
